...
class AlienInvasion:
    ...
    def __init__(self):
        """Инициализирует игру и создает игровые настройки."""
        pygame.init()
    ...
    def _check_events(self):
        """Обрабатывание нажатия клавиш и события мыши."""
    ...
    def _update_aliens(self):
        """
        Проверка достижения флота края экрана.
    ...
    def _update_screen(self):
        ...
        for bullet in self.bullets.sprites():
            bullet.draw_bullet()
        # Отображение флота вторжения
        self.aliens.draw(self.screen)

        # Вывод информации о счете.
        self.sb.show_score()

        # Копка Play отображается в том случае, если игра неактивна.
